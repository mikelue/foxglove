...
testImplementation 'guru.mikelue.foxglove:core:1.0.4'
----
...
libraryDependencies += "guru.mikelue.foxglove" % "core" % "1.0.4" % Test
----
...
[source,xml]
----
<dependency org="guru.mikelue.foxglove" name="core" rev="1.0.4" conf="test"/>
----
