...
* See {foxglove-url}/quickstart/junit[JUnit 5 Quick Start] for usage with https://docs.junit.org/5.10.5/user-guide/[JUnit 5].
* See {foxglove-url}/quickstart/springframework[SpringFramework Quick Start] for usage with https://docs.spring.io/spring-framework/docs/6.0.8/reference/html/testing.html#integration-testing-support-jdbc[SpringFramework - JDBC Testing Support].
...
https://docs.junit.org/5.10.5/user-guide/[image:https://img.shields.io/maven-central/v/org.junit.jupiter/junit-jupiter?filter=5.10.5&label=JUnit[JUnit]]
https://docs.spring.io/spring-framework/docs/6.0.8/reference/html/[image:https://img.shields.io/maven-central/v/org.springframework/spring-framework-bom?filter=6.0.23&label=SpringFramework[SpringFramework]]
link:https://docs.spring.io/spring-boot/docs/3.1.x/reference/html/[image:https://img.shields.io/maven-central/v/org.springframework.boot/spring-boot-starter-parent?filter=3.1.12&label=SpringBoot[SpringBoot]]
link:https://www.instancio.org/user-guide/[image:https://img.shields.io/maven-central/v/org.instancio/instancio-core?filter=5.5.1&label=Instancio[Instancio]]
link:https://openclover.org/documentation[image:https://img.shields.io/maven-central/v/org.openclover/clover-maven-plugin?filter=4.5.2&label=OpenClover[OpenClover]]
